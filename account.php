...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="account.php">SAL</a>
            <a class="navbar-brand" href="account.php">Home</a>
            <a class="navbar-brand" href="display.php">Products</a>
            <div>
                <h5 style="font-size:10px;">Welcome: <?php  echo $_SESSION['user']; ?></h5>
               <a class="navbar-brand" style="font-size: 10px;" href="?logout">Logout</a>
                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="card-title col-auto flex-shrink-1 flex-grow-1">SAL Products</div>
                                <div class="col-atuo">
                                    <a class="btn btn-primary btn-sm btn-flat" href="products.php"><i class="fa fa-plus-square"></i> Add Product(s)</a>
                                </div>
                            </div>
                        </div>
                       <!--  <div class="card-body">
